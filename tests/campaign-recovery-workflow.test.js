...
test('CSV and sheet import clears stale hero data before applying new offer rows', () => {
  ...
  assert.match(html, /\["_img","_imgSource","_imgNeedsReupload","_cropZoom","_cropX","_cropY","_cropPosVersion","_heroFitMode","heroLocked","_itineraryImg","_itineraryImgSource","_itineraryImgNeedsReupload"\]\.forEach\(key=>\{ delete newOffer\[key\]; \}\);/);
