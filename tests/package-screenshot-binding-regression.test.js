...
const package1=[
 ...
 {offerId:'p1-3',ship:'White City Beach Hotel',name:'Antalya, Turkey',operator:'jet2',basePricePerPerson:'843',adults:'2',children:'0'},
 {offerId:'p1-4',ship:'Turgay Apartments',name:'Icmeler, Turkey',operator:'jet2',basePricePerPerson:'583',adults:'2',children:'0'}
];
const package2=[
 ...
 {offerId:'p2-3',ship:'White City Beach Hotel',name:'Antalya, Turkey',operator:'jet2',basePricePerPerson:'703',adults:'2',children:'0',incl:'Luggage & Transfers Included'},
...
test('Test Package 2 preserves full resort separately, shortens only display location, and removes Coach',()=>{
 ...
 assert.deepEqual(offers.map(o=>o.displayLocation),['Tenerife, Spain','Gran Canaria, Spain','Antalya, Turkey','Lassi, Kefalonia']);
